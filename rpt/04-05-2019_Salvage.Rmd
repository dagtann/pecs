...
Plurality $\times$ closeness. The table shows univariate summaries.
...
disproportionality (see the correlation matrix below). Finally, the codings
strike me as untrustworthy. For example, Japan has always had a plurality
